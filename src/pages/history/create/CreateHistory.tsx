...
function CreateHistory(): ReactElement {
  ...
  const renderGroupList = (tagList: ITagResponse[]): React.JSX.Element[] => {
      ...
      <>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col d-flex justify-content-center" style={{ marginTop: '10px', marginBottom: '50px' }}>
              <button
                className="btn btn-primary submit-button"
                type="button"
                style={{ marginRight: "16px" }}
              ...
              <div className="card-body" style={{ marginBottom: "40px" }}>
                <div className="row">
                  <div className="col-sm-12 col-md-12 col-lg-6 col-xxl-6">
                    <div className="mb-3">
                      <PatientDropdownComponent selectedPatientProp={null} sendSelectedPatient={selectedPatient => setSelectedPatient(selectedPatient)} />
                    </div>
                  </div>
                  <div className="col-sm-12 col-md-12 col-lg-6 col-xxl-6">
                  ...
                  <div className="col-sm-12 col-md-12 col-lg-6 col-xxl-6">
                    <div className="mb-3">
                      <label className="form-label"><strong>Add Group</strong></label>
                      <Select
                        inputId="group"
                        isSearchable={true}
                        filterOption={() => true}
