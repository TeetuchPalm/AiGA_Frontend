        ...
        <section className="position-relative py-4 py-xl-5">
          <div className="container">
            <div className="row d-flex d-xl-flex justify-content-center justify-content-xl-center">
              <div className="col-sm-12 col-lg-10 col-xl-9 col-xxl-7 shadow-lg card" style={{ borderRadius: "5px" }}>
                <div className="p-5">
                  ...
                  <div className="mb-3">
                    ...
                    <input className="form-control form-control-user" type="text" name="email" placeholder="Email" onChange={(e) => setUserSignUpRequest({ ...userSignUpRequest, email: e.target.value })} style={{ borderColor: !emailCheck ? "red" : "var(--bs-border-color)" }} /></div>
