        ...
        <section className="position-relative py-4 py-xl-5">
          <div className="container">
            <div className="row mb-5">
              <div className="col"><img className="d-xxl-flex justify-content-xxl-center" src="src/assets/img/AiGAlogowhite.svg" style={{ width: "300px" }} width="300" height="124" /></div>
            </div>
                    ...
                    <form className="text-center" style={{ paddingLeft: "0px" }}>
                      ...
                      <div className="mb-3">
                        <div className="password-label">
                          ...
                          <p className="text-start forget-password" style={{ textAlign: "center", marginTop: "0px", marginBottom: "0px" }}>{<a href={"/reset/password"}>forget password?</a>}</p>
                        </div>
                      ...
                      <div className="mb-3">
                        <button className="btn btn-primary d-block w-100" type="submit" onClick={handleSubmit}>Login</button></div>
                    </form>
                    <p className="text-center">Don't have an account? {<a href={"/register"}>Sign in</a>}</p>
                  </div>
                </div>
              </div>
            </div>
