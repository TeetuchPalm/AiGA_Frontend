                    ...
                    <div className="container-fluid">
                        <div className="container">
                            ...
                            <div className={`nav-elements  ${showNavbar && 'active'}`}>
                                <ul>
                                    <li>
                                        <NavLink to="/patient" className="nav-item" onClick={() => setShowNavbar(false)}>
                                            <svg
                                    ...
                                    <li>
                                        <NavLink to="/history" className="nav-item" onClick={() => setShowNavbar(false)}>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="1em"
                                                height="1em"
                                ...
                                <div className="right-wrap">
                                    {adminTabShow() && <NavLink to="/admin" className="nav-item" onClick={() => setShowNavbar(false)}>
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="1em"
                                            height="1em"
                                    ...
                                    <NavLink to="/login" className="nav-item" onClick={() => { setShowNavbar(false); logout() }}>
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="1em"
                                            height="1em"
